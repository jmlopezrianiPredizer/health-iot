...
class IotServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendData = channel.unary_unary(
                '/IotService/SendData',
                request_serializer=health__pb2.Data.SerializeToString,
                response_deserializer=health__pb2.Response.FromString,
...
def add_IotServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SendData': grpc.unary_unary_rpc_method_handler(
                    servicer.SendData,
                    request_deserializer=health__pb2.Data.FromString,
                    response_serializer=health__pb2.Response.SerializeToString,
            ),
    }
...
class IotService(object):
    ...
    def SendData(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/IotService/SendData',
            health__pb2.Data.SerializeToString,
            health__pb2.Response.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
